...
if GetConvar('voice_useNativeAudio', 'false') == 'true' then
	...
	Cfg.voiceModes = {
		{1.5, "همس"}, -- Whisper speech distance in gta distance units
		{3.0, "طبيعي"}, -- Normal speech distance in gta distance units
		{6.0, "عالي"} -- Shout speech distance in gta distance units
	}
else
	Cfg.voiceModes = {
		{3.0, "همس"}, -- Whisper speech distance in gta distance units
		{7.0, "طبيعي"}, -- Normal speech distance in gta distance units
		{15.0, "عالي"} -- Shout speech distance in gta distance units
	}
end
