...
local requireLua =
require                    -- when importing ox_core chunk, this gets overrides by ox_lib require, which loses stored data
...
for _, moduleName in ipairs(modulesConfig.moduleNames) do
    ...
    if framework ~= 'none' then
        ...
        if not resourceName then
            ...
            framework .. ' on module ' .. moduleName .. '!, please make sure you configured your convars on cfg!')
